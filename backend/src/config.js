...
const namePrefix = "PartyBearSaga";
...
const CONTRACT_NAME = 'PartyBearSaga';
const CONTRACT_SYMBOL = 'PBS';
...
const MINT_PRICE = 1400; // Minting price per NFT. Rinkeby = ETH, Polygon = MATIC. CANNOT BE UPDATED!
...
const GENERIC_DESCRIPTION = "Which Party Bear will you choose?"; // Replace with what you want the generic descriptions to say.
